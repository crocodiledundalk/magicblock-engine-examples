 ...
 */
export type AccountResidency =
  | "BASE_ONLY"
  | "ER_DELEGATED"
  | "ER_CACHE_UNDELEGATED"
  | "ER_LOCAL_ONLY"
  | "TOMBSTONED";
...
export type LifecycleIntent =
  | { kind: "DELEGATE"; accounts: string[] }
  | { kind: "COMMIT"; accounts: string[] }
  | { kind: "UNDELEGATE"; accounts: string[] }
  | { kind: "COMMIT_AND_UNDELEGATE"; accounts: string[] };
...
export type VerifiedLifecycleEvent =
  | { kind: "DELEGATED"; account: string }
  | { kind: "COMMIT_STAGED"; account: string; nonce: bigint }
  | { kind: "COMMIT_FINALIZED"; account: string; nonce: bigint }
  | { kind: "UNDELEGATE_READY"; account: string; nonce: bigint }
  | { kind: "UNDELEGATED"; account: string };
